...
import static com.example.demo.global.result.ResultCode.CHECK_RESET_PASSWORD_CODE_BAD;
import static com.example.demo.global.result.ResultCode.CHECK_RESET_PASSWORD_CODE_GOOD;
import static com.example.demo.global.result.ResultCode.CHECK_USERNAME_BAD;
import static com.example.demo.global.result.ResultCode.CHECK_USERNAME_GOOD;
import static com.example.demo.global.result.ResultCode.CONFIRM_EMAIL_FAIL;
import static com.example.demo.global.result.ResultCode.LOGOUT_SUCCESS;
import static com.example.demo.global.result.ResultCode.REGISTER_SUCCESS;
import static com.example.demo.global.result.ResultCode.RESET_PASSWORD_SUCCESS;
import static com.example.demo.global.result.ResultCode.SEND_CONFIRM_EMAIL_SUCCESS;
import static com.example.demo.global.result.ResultCode.SEND_RESET_PASSWORD_EMAIL_SUCCESS;
import static com.example.demo.global.result.ResultCode.UPDATE_PASSWORD_SUCCESS;
...
import com.example.demo.domain.member.service.MemberAuthService;
import com.example.demo.global.config.security.util.RequestExtractor;
import com.example.demo.global.exception.types.FilterMustRespondException;
...
public class MemberAuthController {
	...
	public ResponseEntity<ResultResponse> register(@Valid @RequestBody RegisterRequestDto registerRequest) {
	...
	public ResponseEntity<ResultResponse> sendConfirmEmail(
		@Valid @RequestBody SendConfirmationEmailRequestDto sendConfirmationEmailRequest) {
	...
	public ResponseEntity<ResultResponse> loginWithCode(
		@Valid @RequestBody LoginWithCodeRequestDto loginWithCodeRequest) {
		throw new FilterMustRespondException();
	}
